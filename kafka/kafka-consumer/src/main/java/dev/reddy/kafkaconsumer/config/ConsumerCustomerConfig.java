package dev.reddy.kafkaconsumer.config;
...
public class ConsumerCustomerConfig {
    ...
    @Bean
     public Map<String, Object> customerConsumerConfig() {
        ...
        // props.put( JsonDeserializer.VALUE_DEFAULT_TYPE, "dev.reddy.kafkaconsumer.dto.Customer");
         props.put( JsonDeserializer.TRUSTED_PACKAGES, "dev.reddy.kafkaconsumer.dto");
         return  props;
     }

     @Bean
     public ConsumerFactory<String, Object> consumerCustomerFactory() {
